...
# patch pour la variable skt qui n'est pas lue correctement par ce script dans les données Titan
# copié depuis /perm/fra7547/venvs/memoptim_anemoi-d9b8dc1576/lib/python3.11/site-packages/anemoi/training/utils/variables_metadata.py
...
class ExtractVariableGroupAndLevel:
    ...
    def get_group_and_level(self, variable_name: str) -> tuple[str, str, int]:
        ...
        """
        variable_level = None
        mars_metadata_available = self.metadata_variables and variable_name in self.metadata_variables and self.metadata_variables[variable_name].get("mars")
